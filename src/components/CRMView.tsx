...
import { Users, Plus, Search, Filter, Trash2, Mail, Phone, MapPin, Calendar, CheckCircle2, ArrowRight, Zap, RefreshCw } from 'lucide-react';
...
export const CRMView: React.FC<CRMViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      {/* Top Banner Header */}
      <div className="bg-white dark:bg-zinc-950 text-slate-900 dark:text-white p-7 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover-card-lift transition-all">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-rose-600 dark:text-rose-500 uppercase tracking-widest mb-1">
            ...
            <span>CRM Pipeline & Deal Management</span>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-zinc-950 p-5 rounded-3xl border border-slate-200 dark:border-zinc-800 text-center shadow-xs hover-card-lift transition-all">
